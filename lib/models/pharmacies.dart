  ...
  factory Pharmacy.fromJson(Map<String, dynamic> json) {
    return Pharmacy(
      ...
      latitude: json['lat']?.toDouble() ??
          0.0, // Convert latitude to double, default to 0.0 if not present
      longitude: json['lon']?.toDouble() ??
          0.0, // Convert longitude to double, default to 0.0 if not present
      otherInfo: json['other_info'],
      distance: json['distance']?.toDouble() ??
          0.0, // Convert distance to double, default to 0.0 if not present
    );
  }
}
